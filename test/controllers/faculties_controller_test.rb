...
class FacultiesControllerTest < ActionController::TestCase
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post :create, faculty: { emp_id: @faculty.emp_id, ip_committee: @faculty.ip_committee, user_id: @faculty.user_id }
    end
  ...
  test "should update faculty" do
    patch :update, id: @faculty, faculty: { emp_id: @faculty.emp_id, ip_committee: @faculty.ip_committee, user_id: @faculty.user_id }
    assert_redirected_to faculty_path(assigns(:faculty))
  end
