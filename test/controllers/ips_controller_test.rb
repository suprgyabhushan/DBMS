...
class IpsControllerTest < ActionController::TestCase
  ...
  test "should create ip" do
    assert_difference('Ip.count') do
      post :create, ip: { description: @ip.description, domain_id: @ip.domain_id, identify_id: @ip.identify_id, status: @ip.status, title: @ip.title, type: @ip.type }
    end
  ...
  test "should update ip" do
    patch :update, id: @ip, ip: { description: @ip.description, domain_id: @ip.domain_id, identify_id: @ip.identify_id, status: @ip.status, title: @ip.title, type: @ip.type }
    assert_redirected_to ip_path(assigns(:ip))
  end
